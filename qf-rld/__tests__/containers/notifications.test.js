import {mapStateToProps} from '../../app/containers/NotificationsButtonContainer'

it('should be ordered, trimmed and counted', () => {
  expect(mapStateToProps(initialState)).toEqual(targetState)
});
